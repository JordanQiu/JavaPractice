...
public class zhishu {
	...
	public static List<Integer> allzhishuyinzi(int num){
		...
		return yinZiList;
		//本函数递归的出口是最后一次是质数，然后直接跳到else中，不再进入 yinZiList.addAll(allzhishuyinzi(remainNum));再return。
...
//			System.out.println(zhishu().get(i));
//		}
		List<Integer> yinZiList = allzhishuyinzi(121);
